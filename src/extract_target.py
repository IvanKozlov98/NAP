...
def parse_cmdline():
    parser = argparse.ArgumentParser(description="Extract target for model from hic-data")
    ...
    parser.add_argument("-o", "--output", type=str, help="name of output file with target", required=True)
